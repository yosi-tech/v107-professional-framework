...
const ARCHETYPES = {
  ...
  strategicNetworker: {
    ...
    gap: 'טקטי לא אסטרטגי',
    variants: [
      'אתה מכיר כולם, אבל לא יודע לאן ללכת עם זה.',
      'הרשת שלך היא זהב, אבל חסרה לך מפת דרכים.',
      'קשרים ללא כיוון הם כמו כוח ללא מטרה.',
      'מתוך 107 שאלות, דפוס מרתק צף: אתה בונה, אבל לא מתכנן.'
    ]
  },
  executionMachine: {
    name: 'מכונת הביצוע',
    ...
    gap: 'קשיחות בשינוי',
    variants: [
      'אתה מצוין בביצוע, אבל שובר כשהתוכנית משתנה.',
      'המערכת עובדת כל עוד אף אחד לא משנה את הכללים.',
      'תכנון מושלם הוא הכוח שלך, גמישות היא החולשה שלך.',
      'דפוס נדיר: 8% מהמשתמשים משלבים תכנון גבוה עם גמישות נמוכה.'
    ]
  },
  adaptiveInnovator: {
    name: 'החדשן הגמיש',
    ...
    gap: 'שחיקה מהירה',
    variants: [
      'אתה מסתגל מהר, אבל לא מחזיק לטווח ארוך.',
      'גמישות ללא חוסן היא מתכון לשחיקה.',
      'אתה יכול להסתגל לכל דבר, אבל לא לשמור על זה.',
      'פרופיל נדיר: רק 5% מצליחים לשלב חדשנות עם חוסן נמוך.'
    ]
  },
  resilientLeader: {
    name: 'המנהיג העמיד',
    ...
    variants: [
      'אתה מצטיין במשברים, אבל חסר כיוון אסטרטגי.',
      'חוסן ללא חזון הוא ניצחון טקטי, לא אסטרטגי.',
      'אתה תמיד עומד בלחץ, אבל לא יודע לאן אתה הולך.',
      'דפוס נדיר: רק 7% מהמנהלים משלבים חוסן גבוה עם חזון נמוך.'
    ]
  },
  visionaryCommunicator: {
    ...
    variants: [
      'אתה רואה את העתיד, אבל לא יודע איך להגיע לשם.',
      'חזון ללא תכנית הוא חלום, לא אסטרטגיה.',
      'אתה מדבר על מחר, אבל תקוע בהיום.',
      '107 שאלות חשפו: רק 4% רואים את התמונה הגדולה ללא התוכנית.'
    ]
  }
};
