...
export function getFullReportPurchaseEmailTemplate(userName, transactionId, date, hasCompletedQuestionnaire, questionnaireUrl, isExpress, language = 'he') {
  ...
  const content = {
    he: {
      ...
      whatsNext: "מה הלאה:",
      step1Completed: `אם השאלון כבר הושלם — הדו״ח האישי יישלח אליך תוך 5 ימי עבודה לאחר ביקורת אנושית${isExpress ? ' (אספקה מואצת - 3 ימי עבודה)' : ''}.`,
      ...
      included3: `מסירת דו״ח תוך 5 ימי עבודה${isExpress ? ' (מואץ - 3 ימי עבודה)' : ''} לכתובת המייל שמסרת`,
    ...
    en: {
      ...
      step1Completed: `If the questionnaire is already completed — Your personal report will be sent within 5 business days after human review${isExpress ? ' (express delivery - 3 business days)' : ''}.`,
      ...
      included3: `Report delivery within 5 business days${isExpress ? ' (express - 3 business days)' : ''} to the email address you provided`,
