...
export default function MessageBubble({ message }) {
    ...
    return (
        <div className={cn("flex gap-3 my-4", isUser ? "justify-end" : "justify-start")}>
            {!isUser && (
                <div className="h-9 w-9 rounded-full bg-gradient-to-br from-blue-500 to-purple-500 flex items-center justify-center flex-shrink-0 mt-0.5 shadow-md">
            ...
            <div className={cn("max-w-[85%]", isUser && "flex flex-col items-end")}>
                {message.content && (
                    <div className={cn(
                        ...
                        isUser ? "bg-slate-800 text-white rounded-br-lg" : "bg-white border border-slate-200 rounded-bl-lg"
                    )}>
                        {isUser ? (
