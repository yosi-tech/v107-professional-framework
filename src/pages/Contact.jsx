              ...
              <div key={name} className="flex flex-col items-center group">
                <div className="relative w-48 h-48 mb-8">
                  ...
                  <div className="w-full h-full rounded-full overflow-hidden border-4 border-white shadow-lg relative z-10">
                    <img className={`w-full h-full grayscale group-hover:grayscale-0 transition-all duration-500 ${name === "ליה ליין" ? "object-contain scale-[1.94] object-[center_80%]" : name === "גיא פרנסס" ? "object-contain scale-[1.94] object-center" : "object-contain scale-[1] object-center"}`} src={img} alt={name} />
                  </div>
                </div>
