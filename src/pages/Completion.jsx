    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[625px] rtl text-right">
                <DialogHeader>
                    <DialogTitle className="text-2xl font-bold">התהליך המקצועי מאחורי הדו"ח</DialogTitle>
                    <DialogDescription className="text-gray-600 mt-2">
                        השאלון שסיימתם למלא הוא רק הצעד הראשון. דו"ח V107 המלא עובר תהליך ניתוח מעמיק ורב-שלבי על מנת להבטיח שתקבלו את התובנות המדויקות והמעשיות ביותר.
                    </DialogDescription>
                </DialogHeader>
